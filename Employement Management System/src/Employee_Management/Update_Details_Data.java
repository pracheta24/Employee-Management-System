...
public class Update_Details_Data extends JFrame implements ActionListener
{
    ...
    Update_Details_Data()
    {
        ...
        try
        {
            ConnectionClass obj = new ConnectionClass();  //this for fetching data from database
       ...
       ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("Employee_Management/icon/emp.jpeg"));
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(e.getSource()==bt1)
        {
            try
            {
                ...
                String q1 ="update employee set name='"+name+"',fname='"+fname+"',age='"+age+"',dob='"+dob+"',address='"+address+"',phone='"+phone+"',email='"+email+"',education='"+education+"',job_post='"+job_post+"',aadhar='"+aadhar+"' where eid='"+id+"'";
