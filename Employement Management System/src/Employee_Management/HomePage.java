//in homepage we are creating menubar,menuitem and 1 image for background
...
{
    JLabel l1,l2,l3,l4,l6,l7,l8,l9,l10;
    Font f, f1,f2;
    JPanel p1;
    HomePage()
    {
      ...
      ImageIcon ic = new ImageIcon(ClassLoader.getSystemResource("Employee_Management/icon/Employees.jpg"));
    ...
    public void actionPerformed(ActionEvent e)
    {
         ...
         else if(comnd.equals("Apply Leave"))
        {
         ...
         else if(comnd.equals("View Leave"))
        {
