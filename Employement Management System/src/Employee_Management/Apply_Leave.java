...
public class Apply_Leave extends JFrame implements ActionListener
{
    ...
    Choice ch1,ch2;
     ...
     Apply_Leave()
     {
        ...
        tf2.setEditable(false);  //it is a confidential detail we cannot edit it
       ...
       ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("Employee_Management/icon/leave.jpeg"));
